...
<head>
    ...
    <title>Data Dosen | Admin SinSen</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Data Dosen <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#addData"><i class="fa fa-plus-circle"></i> Add</button></strong>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                      @foreach($dosen as $key => $data)
                                        <tr>
                                          ...
                                          <td>{{ $data->nama }}</td>
                                          <td>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteData" data-nip = "{{ $data->nip }}"><i class="fa fa-trash"></i> Delete</button>
                                          </td>
                                        </tr>
                                      @endforeach
                                    </tbody>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><span class="fa fa-plus-circle"></span> Add Data Dosen</h4>
              </div>
              <div class="modal-body">
                <form id="modal-form-add" action="{{ route('addDosen') }}" method="post" role="form">
                  {{ csrf_field() }}
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <form id="modal-form-delete" method="post" action="{{ route('deleteDosen') }}">
                    {{ csrf_field() }}
              <div class="modal-body">
                    <input type="hidden" name="nip" id="cat_nip" value="">
                    ...
                    if( res.error == 0 ){
                      ...
                      swal(
                        ...
                        res.message,
                          ...
                          if(OK){
                              window.location.href = "{{ route('dataDosen') }}";
                          }
                        });
                    } else{
                        $('#addData').modal('hide');
