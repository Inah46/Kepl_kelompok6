...
<head>
    ...
    <title>Data Mahasiswa | Admin SinSen</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Data Mahasiswa <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#addData"><i class="fa fa-plus-circle"></i> Add</button></strong>
                            </div>
                            <div class="card-body">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><span class="fa fa-plus-circle"></span> Add Data Mahasiswa</h4>
              </div>
              <div class="modal-body">
                <form id="modal-form-add" action="{{ route('addMahasiswa') }}" method="post" role="form">
                  {{ csrf_field() }}
                  ...
                  <div class="form-group has-success">
                    ...
                    <input type="kelas" id="kelas" name="kelas" class="form-control" required />
                  </div>
                  <div class="form-group has-success">
                    <label for="jurusan" class="form-control-label">Jurusan</label>
                    <input type="jurusan" id="jurusan" name="jurusan" class="form-control" required />
                  </div>
                  <div class="form-group has-success">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <form id="modal-form-delete" method="post" action="{{ route('deleteMahasiswa') }}">
                    {{ csrf_field() }}
              <div class="modal-body">
                    ...
                    if( res.error == 0 ){
                      ...
                      swal(
                        ...
                        res.message,
                          ...
                          if(OK){
                              window.location.href = "{{ route('dataMahasiswa') }}";
                          }
                        });
                    } else{
                        $('#addData').modal('hide');
