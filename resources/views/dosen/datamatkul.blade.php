...
<head>
    ...
    <title>Data Mata Kuliah | Dosen SinSen</title>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="#"><b>  > SinSen</b></a>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="{{ route('logoutDosen') }}"><i class="fa fa-power -off"></i>Logout</a>
                        </div>
                    </div>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="{{ route('dashboardDosen') }}">Dashboard</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Data Mata Kuliah <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#addData"><i class="fa fa-plus-circle"></i> Add</button></strong>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                      @foreach($mk as $key => $data)
                                        <tr>
                                          ...
                                          <td>{{ $data->sks }}</td>
                                          <td>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteData" data-kd_mk = "{{ $data->kd_mk }}"><i class="fa fa-trash"></i> Delete</button>
                                          </td>
                                        </tr>
                                      @endforeach
                                    </tbody>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><span class="fa fa-plus-circle"></span> Add Data Matkul</h4>
              </div>
              <div class="modal-body">
                <form id="modal-form-add" action="{{ route('addMatkul') }}" method="post" role="form">
                  {{ csrf_field() }}
                  <div class="form-group has-success">
                    <label for="kd_mk" class="form-control-label">Kode Matkul</label>
                    <input type="text" id="kd_mk" name="kd_mk" class="form-control" required/>
                    <span class="text-warning" ></span>
                  </div>
                  <div class="form-group has-success">
                    <label for="mata_kuliah" class="form-control-label">Mata Kuliah</label>
                    <input type="text" id="mata_kuliah" name="mata_kuliah" class="form-control" required />
                  </div>
                  <div class="form-group has-success">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <form id="modal-form-delete" method="post" action="{{ route('deleteMatkul') }}">
                    {{ csrf_field() }}
              <div class="modal-body">
                    <input type="hidden" name="kd_mk" id="cat_kdmk" value="">
        ...
        $(document).ready(function() {
          ...
          formAdd.submit(function (e) {
                    ...
                    if( res.error == 0 ){
                      ...
                      swal(
                        ...
                        res.message,
                          ...
                          if(OK){
                              window.location.href = "{{ route('datamk') }}";
                          }
                        });
                    } else{
                        $('#addData').modal('hide');
            ...
            $('#deleteData').on('show.bs.modal', function (event) {
              ...
              var kd_mk = button.data('kd_mk')
              var modal      = $(this)
              modal.find('.modal-body #cat_kdmk').val(kd_mk)
            });
