...
<head>
    ...
    <title>Data QR Code | Dosen SinSen</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Data QR Code</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Data QR Code <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#addData"><i class="fa fa-plus-circle"></i> Add</button></strong>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                      @foreach($qr as $key => $data)
                                        <tr>
                                          ...
                                          <td>{{ $data->date }}</td>
                                          <td>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteData" data-kd_qr = "{{ $data->kd_qr }}"><i class="fa fa-trash"></i> Delete</button>
                                          </td>
                                        </tr>
                                      @endforeach
                                    </tbody>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><span class="fa fa-plus-circle"></span> Add Data QR Code</h4>
              </div>
              <div class="modal-body">
                <form id="modal-form-add" action="{{ route('addQrCode') }}" method="post" role="form">
                  {{ csrf_field() }}
                  <div class="form-group has-success">
                    <label for="kd_mk" class="form-control-label">Kode Matkul</label>
                    <select name="kd_mk" class="form-control">
                      @foreach($mk as $data)
                        <option value="{{ $data->kd_mk }}">{{ $data->mata_kuliah }}</option>
                      @endforeach
                    </select>
                  </div>
                  <div class="form-group has-success">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <form id="modal-form-delete" method="post" action="{{ route('deleteQrCode') }}">
                    {{ csrf_field() }}
              <div class="modal-body">
                    <input type="hidden" name="kd_qr" id="cat_kdqr" value="">
        ...
        $(document).ready(function() {
          ...
          formAdd.submit(function (e) {
                    ...
                    if( res.error == 0 ){
                      ...
                      swal(
                        ...
                        res.message,
                          ...
                          if(OK){
                              window.location.href = "{{ route('dataqr') }}";
                          }
                        });
                    } else{
                        $('#addData').modal('hide');
            ...
            $('#deleteData').on('show.bs.modal', function (event) {
              ...
              var kd_qr = button.data('kd_qr')
              var modal      = $(this)
              modal.find('.modal-body #cat_kdqr').val(kd_qr)
            });
